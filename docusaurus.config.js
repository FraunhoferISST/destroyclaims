...
const config = {
  title: 'Destroy Claims',
  tagline: 'Destroy Claims',
  url: 'https://fraunhoferisst.github.io/',
  baseUrl: '/destroyclaims/',
  ...
  projectName: 'destroyclaims', // Usually your repo name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/FraunhoferISST/destroyclaims',
            label: 'GitHub',
            position: 'right',
